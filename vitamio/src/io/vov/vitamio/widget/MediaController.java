...
public class MediaController extends FrameLayout {
    ...
    private static class MyAdapter extends Handler {
        private WeakReference<MediaController> weakReference;

        public MyAdapter(MediaController controller) {
            weakReference = new WeakReference<MediaController>(controller);
        }
        ...
        public void handleMessage(Message msg) {
            ...
            MediaController controller = weakReference.get();
            if (controller == null) {
                return;
            }
            long pos;
